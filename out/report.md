...
|---:|---|---|---:|---:|---:|
| 1 | 文化庁 | 組織・地域・人物 | 141 | 23 | 0.1874 |
| 2 | 認定 | 語 | 48 | 9 | 0.2739 |
| 3 | 文化審議会 | 組織・地域・人物 | 47 | 22 | 0.1047 |
| 4 | 文化観光 | 政策・制度・法令 | 42 | 2 | 0.0000 |
| 5 | 関する | 語 | 39 | 10 | 0.0168 |
| 6 | 博物館 | 語 | 38 | 10 | 0.1436 |
| 7 | 報道 | 語 | 38 | 6 | 0.0168 |
| 8 | 日本遺産 | 政策・制度・法令 | 36 | 5 | 0.0558 |
| 9 | 登録 | 語 | 36 | 9 | 0.1858 |
| 10 | 美術館 | 語 | 36 | 7 | 0.0801 |
| 11 | 職員 | 語 | 35 | 8 | 0.0000 |
| 12 | 文化 | 語 | 34 | 4 | 0.0418 |
| 13 | 申請 | 語 | 32 | 1 | 0.0000 |
| 14 | 広報 | 語 | 31 | 2 | 0.0000 |
| 15 | 理由 | 語 | 31 | 8 | 0.0000 |
| 16 | 障害 | 語 | 31 | 8 | 0.0000 |
| 17 | お知らせメニュー開閉 | 語 | 30 | 2 | 0.0000 |
| 18 | 出版物メニュー開閉 | 語 | 30 | 2 | 0.0000 |
| 19 | 対応要領 | 語 | 30 | 8 | 0.0000 |
| 20 | 差別 | 語 | 30 | 8 | 0.0000 |
| 21 | 情報公開メニュー開閉 | 語 | 30 | 1 | 0.0000 |
| 22 | 推進本部 | 語 | 30 | 2 | 0.0000 |
| 23 | 白書 | 語 | 30 | 2 | 0.0000 |
| 24 | 相談窓口 | 語 | 30 | 8 | 0.0000 |
| 25 | 統計 | 語 | 30 | 2 | 0.0000 |
| 26 | 解消 | 語 | 30 | 8 | 0.0000 |
| 27 | 食文化推進本部 | 語 | 30 | 2 | 0.0000 |
| 28 | 世界文化遺産 | 政策・制度・法令 | 27 | 8 | 0.0366 |
| 29 | 文化財保存活用地域計画 | 政策・制度・法令 | 26 | 1 | 0.0000 |
| 30 | 文化政策 | 語 | 26 | 3 | 0.0004 |
...
|---:|---|---:|---:|---:|
| 1 | 推進本部 — 食文化推進本部 | 1.000 | 30 | 1.000 |
| 2 | 出版物メニュー開閉 — 白書 | 1.000 | 30 | 1.000 |
| 3 | 出版物メニュー開閉 — 統計 | 1.000 | 30 | 1.000 |
| 4 | 白書 — 統計 | 1.000 | 30 | 1.000 |
| 5 | 対応要領 — 差別 | 1.000 | 30 | 1.000 |
| 6 | 対応要領 — 相談窓口 | 1.000 | 30 | 1.000 |
| 7 | 対応要領 — 解消 | 1.000 | 30 | 1.000 |
| 8 | 差別 — 相談窓口 | 1.000 | 30 | 1.000 |
| 9 | 差別 — 解消 | 1.000 | 30 | 1.000 |
| 10 | 相談窓口 — 解消 | 1.000 | 30 | 1.000 |
| 11 | 下記 — 通り開催 | 1.000 | 17 | 1.000 |
| 12 | 保持者 — 認定等 | 1.000 | 6 | 1.000 |
| 13 | 妖怪画コレクション — 幽霊 | 1.000 | 5 | 1.000 |
| 14 | 強化基金 — 文化芸術活動基盤 | 1.000 | 5 | 1.000 |
| 15 | 克彦 — 議決 | 1.000 | 4 | 1.000 |
| 16 | 無断 — 録画 | 1.000 | 4 | 1.000 |
| 17 | 無断 — 録音 | 1.000 | 4 | 1.000 |
| 18 | 録画 — 録音 | 1.000 | 4 | 1.000 |
| 19 | docomomo — ジャパン | 1.000 | 4 | 1.000 |
| 20 | 対応要領 — 理由 | 0.991 | 30 | 0.968 |
| 21 | 対応要領 — 障害 | 0.991 | 30 | 0.968 |
| 22 | 差別 — 理由 | 0.991 | 30 | 0.968 |
| 23 | 差別 — 障害 | 0.991 | 30 | 0.968 |
| 24 | 相談窓口 — 理由 | 0.991 | 30 | 0.968 |
| 25 | 相談窓口 — 障害 | 0.991 | 30 | 0.968 |
| 26 | 解消 — 理由 | 0.991 | 30 | 0.968 |
| 27 | 解消 — 障害 | 0.991 | 30 | 0.968 |
| 28 | お知らせメニュー開閉 — 広報 | 0.991 | 30 | 0.968 |
| 29 | 藤原 — 飛鳥 | 0.982 | 12 | 0.923 |
| 30 | 情報公開メニュー開閉 — 申請 | 0.981 | 30 | 0.938 |
...
|---:|---|---:|---:|---:|:--:|
| 1 | 廃棄 — 資料 | +0.596 | 0.867 | 0.271 |  |
| 2 | 博物館 — 資料 | +0.587 | 1.000 | 0.413 |  |
| 3 | 日本 — 文化政策 | +0.581 | 0.815 | 0.234 |  |
| 4 | 政策 — 文化 | +0.499 | 0.815 | 0.315 |  |
| 5 | 地域 — 展開 | +0.456 | 1.000 | 0.544 |  |
| 6 | 歴史 — 文化 | +0.440 | 0.815 | 0.374 |  |
| 7 | 地域 — 文化 | +0.416 | 0.815 | 0.399 |  |
| 8 | 廃棄 — 博物館 | +0.373 | 0.867 | 0.494 |  |
| 9 | 博物館 — 明記 | +0.288 | 0.706 | 0.418 |  |
| 10 | 受賞 — 文化政策 | +0.287 | 0.815 | 0.527 |  |
| 11 | 文化政策 — 無い | +0.241 | 0.629 | 0.389 |  |
| 12 | 公募型プロポーザル — 活用 | +0.240 | 0.815 | 0.574 |  |
| 13 | 博物館 — 問題 | +0.226 | 0.706 | 0.480 |  |
| 14 | 地域計画 — 文化観光推進法 | +0.209 | 1.000 | 0.791 |  |
| 15 | 地域計画 — 拠点計画 | +0.163 | 1.000 | 0.837 |  |
| 16 | 拠点計画 — 文化観光推進法 | +0.162 | 1.000 | 0.838 |  |
| 17 | 認定 — 生きる | +0.118 | 0.566 | 0.447 |  |
| 18 | 文化 — 観光 | +0.116 | 0.629 | 0.513 |  |
| 19 | 日本遺産 — 生きる | +0.068 | 0.584 | 0.516 |  |
| 20 | 妖怪画コレクション — 特別展 | +0.041 | 1.000 | 0.959 |  |

## 文化施設・政策と結びついている語

- **文化観光推進法**（政策・制度・法令, 出現20文）: 拠点計画(0.85), 地域計画(0.80), 観光庁(0.73), 認定(0.65), 計画(0.60), 拠点(0.50), 報道(0.40), 支援(0.36)
- **世界文化遺産**（政策・制度・法令, 出現27文）: 藤原(0.70), 決議(0.70), 飛鳥(0.68), 宮都(0.68), 記載(0.61), 部会(0.55), 委員会(0.52), 文化審議会(0.25)
- **文化資源**（政策・制度・法令, 出現10文）: 記念物課(0.93), 政策(0.82), 担当(0.60), 文化庁(0.39)
- **日本遺産**（政策・制度・法令, 出現36文）: 紡ぐ(0.62), 生きる(0.60), 公募型プロポーザル(0.56), 魅力(0.48), 歴史(0.47)
- **史跡名勝天然記念物**（政策・制度・法令, 出現7文）: 指定等(0.90), 登録記念物(0.76), 答申(0.60), 文化審議会(0.37)
- **博物館法**（政策・制度・法令, 出現23文）: 改正(0.82), 博物館登録制度(0.61), 博物館(0.45), 登録(0.33)
- **指定管理者制度**（政策・制度・法令, 出現17文）: 運営(0.55), 美術館(0.53), 公募(0.47), 劇場(0.46)
- **文化観光**（政策・制度・法令, 出現42文）: 推進本部(0.90), 食文化推進本部(0.90)
- **国宝**（政策・制度・法令, 出現6文）: 亀虎古墳壁画(0.97)
- **登録有形文化財**（政策・制度・法令, 出現4文）: 建造物(0.90)
- **博物館登録制度**（政策・制度・法令, 出現6文）: 博物館法(0.61)
- **文化財保存活用地域計画**（政策・制度・法令, 出現26文）: 認定(0.51)
- **無形文化遺産**（政策・制度・法令, 出現5文）: 文化審議会(0.43)

## 話題のかたまり（Louvain コミュニティ）

- **クラスタ 0**（23語）: 文化審議会、答申、議決、克彦、同審議会文化財分科会、文部科学大臣、審議、経る、認定等、保持者、指定、史跡名勝天然記念物
- **クラスタ 1**（15語）: 文化庁、関する、解消、相談窓口、差別、対応要領、障害、理由、職員、古墳壁画、保存活用、会議開催
- **クラスタ 2**（14語）: 日本遺産、文化、歴史、地域、紡ぐ、活用、公募型プロポーザル、生きる、文化財、事業、保存、展開
- **クラスタ 3**（13語）: 文化観光推進法、認定、地域計画、報道、拠点計画、観光庁、お知らせメニュー開閉、広報、計画、拠点、年フード、策定
- **クラスタ 4**（12語）: 博物館、博物館法、廃棄、改正、収蔵庫、資料、基準、博物館登録制度、問題、収蔵品、明記、稼ぐ
- **クラスタ 5**（11語）: 美術館、指定管理者制度、公募、運営、劇場、指定管理、求める、高知県、国立博物館、巡る、施設
- **クラスタ 6**（8語）: 採択先、決定、文化芸術活動基盤、強化基金、コンテンツ制作、クリエーター支援基金、中核、発信
- **クラスタ 7**（8語）: 世界文化遺産、決議、藤原、宮都、飛鳥、記載、委員会、国語分科会言語資源
- **クラスタ 8**（7語）: 担当、政策、記念物課、文化資源、参事官、芸術文化担当、支援
- **クラスタ 9**（6語）: 遠慮、録音、録画、無断、撮影、無断転載

## 最近の記事

新しい順に20件（全461件は `articles.html` / `articles.csv`）。
